...
- **Case 2 - Lazy Evaluation으로 연산량 감소 검증**
  ...
  - [상세 문서 보기](https://github.com/woorifisa-6th-n8n-chatbot-team/mistakes-in-java-streams/blob/main/docs/case2-lazy-short-circuit.md)
  - 담당자: (HiLeeS)
...
| **Sequential Stream** | 1322.5975 ms |
